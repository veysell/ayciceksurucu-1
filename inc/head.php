...
<head>
    <meta charset="utf-8">
    <title><?= $page ?>Ayçiçek Sürücü Kursu</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Yenişehir,Kırıkkale,Ayçiçek Sürücü Kursu" name="keywords">
    <meta content="Yenişehir Ayçiçek Sürücü Kursu" name="description">
...
<body>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                ...
                <div class="h-100 d-inline-flex align-items-center py-3">
                    ...
                    <small>Pazartesi - Cuma : 09.00  - 19.00 PM</small>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="anasayfa" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">AYÇİÇEK SÜRÜCÜ KURSU</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="ekibimiz" class="nav-item nav-link">KADROMUZ</a>
